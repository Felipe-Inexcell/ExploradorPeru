...
public class SoapRequestMovistar {
    ...
    private static final String URL = "http://186.103.141.44/ws/smartphone/sca_devPeru.php";
     ...
     */
    //TODO: en revision
    public static String getCertifyDSL(String Area,String Phone, String Type, String Value, String IMEI, String IMSI) throws Exception {
...
// in milliseconds which is the timeout for waiting for data.
    ...
    public static String getResource(String IMEI, String IMSI, String Area, String Phone) throws Exception, HttpHostConnectException, HttpResponseException, SocketException, SocketTimeoutException {
...
// in milliseconds which is the timeout for waiting for data.
    ...
    public static String getActionButton(String IMEI, String IMSI, String Area, String Phone, String Type, String Action) throws Exception {
...
// in milliseconds which is the timeout for waiting for data.
    ...
    public static String guardarFact(String Phone, String IMEI, String IMSI, String OperationCode, String OperationId, ArrayList<FormularioEnvio> formulario, ArrayList<String> decos) throws Exception {
        ...
        if(decos != null && decos.size() > 0 ) {
            bodyOut += "<IngresarSerial xsi:type=\"urn:IngresarSerialData\">" +
                    "<Serial xsi:type=\"urn:SerialesData\">" +
    ...
    public static String getDCTOnDemand(String IMEI, String IMSI, String AREA,String PHONE) throws IOException {
...
// in milliseconds which is the timeout for waiting for data.
    ...
    public static String getParaElectri(String IMEI, String IMSI, String AREA, String PHONE) throws IOException {
